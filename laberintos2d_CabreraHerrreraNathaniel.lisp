...
;;=======================================================================
(defun  create-node (estado  op &optional (heur ()) (prof ()) (val ()))
    ...
    (if (equal heur nil)
        (list  (1-  *id*)  estado  *current-ancestor*  (first op) (second op)) 
        (if (equal prof nil)
            (list  (1-  *id*)  estado  *current-ancestor*  (first op) (second op) heur) 
            (list  (1-  *id*)  estado  *current-ancestor*  (first op) (second op) heur prof val) 
        )    
    )
...
(defun  valid-operator (op  pos)
    ...
    (let*
        ...
        (case operador 
            (:up  
               (if (or (equal paredes 4) (equal paredes 5)  (equal paredes 6) (equal paredes 7) (equal paredes 12) (equal paredes 13) (equal paredes 14) (equal paredes 15 ))
                   NIL
                   ;;else
                   T
               )
                            ...
                            (progn
                                ...
                                (if (and 
                                    ...
                                    (progn
                                        ...
                                        (if (or (equal panterior 3) (equal panterior 7) (equal panterior 11) (equal panterior 15)) 
                                            NIL
                                            T
                                        )
                                    )
            ...
            (:right  
                (if (or (equal paredes 8) (equal paredes 9)  (equal paredes 10) (equal paredes 11) (equal paredes 12) (equal paredes 13) (equal paredes 14) (equal paredes 15 ))
                    NIL
                    ;;else
                    T
                )
                        ...
                        (if (and 
                            ...
                            (progn
                                ...
                                (if (and 
                                    ...
                                    (progn
                                        (setq panterior (get-cell-walls (1- y) (1+ x)))
                                        (if (or (equal panterior 12) (equal panterior 13) (equal panterior 14) (equal panterior 15)) 
                                            NIL
                                            T
                                        )
                                    )
            ...
            (:left 
                (if (or (equal paredes 2) (equal paredes 3)  (equal paredes 6) (equal paredes 7) (equal paredes 10) (equal paredes 11) (equal paredes 14) (equal paredes 15 ))
                    NIL
                    ;;else
                    T
                )
                        ...
                        (if (and 
                            ...
                            (progn
                                ...
                                (if (and 
                                    ...
                                    (progn
                                        (setq panterior (get-cell-walls (1+ y) (1+ x)))
                                        (if (or (equal panterior 9) (equal panterior 11) (equal panterior 13) (equal panterior 15)) 
                                            NIL
                                            T
                                        )
                                    )
    ...
    (let ((descendientes  nil)(nuevo-pos  nil))
        (dolist  (op  *Ops*  descendientes) 
		   ...
		   (when (and (valid-pos  nuevo-pos) (valid-operator  op  nuevo-pos))
	           (setq  descendientes  (cons  (list nuevo-pos op) descendientes))
           )
        )
    ) 
)
...
;;=======================================================================
(defun  remember-pos?  (pos  lista-memoria)
    ...
    "Filtra una lista de estados-y-operadores quitando aquellos elementos cuyo estado está en la memoria que se le ingrese
     ...
     (let ((memoriasXD memorias))
        (cond 
            ...
            ((remember-pos? (first (first  lista-estados-y-ops)) memoriasXD)  ;; si se recuerda el primer elemento de la lista, filtrarlo...
    ...
    (let  ((nodo  nil))
         (dotimes  (i (length  lista-nodos))
              ...
              (if  (= i 0)
                   ...
                   (progn
                        (if (= (length nodo) 6) 
                            (format t "\(~A\) aplicando ~A  se  llega  a  ~A . Heuristica ~A  ~%"  i (fourth  nodo)  (second  nodo) (sixth nodo));; imprimir el número de paso, operador y pos...
                            (if (= (length nodo) 8) 
                                (format t "\(~A\) aplicando ~A  se  llega  a  ~A. Heuristica ~A ~%"  i (fourth  nodo)  (second  nodo) (eighth nodo));; imprimir el número de paso, operador y pos...
                                (format t "\(~A\) aplicando ~A  se  llega  a  ~A ~%"  i (fourth  nodo)  (second  nodo));; imprimir el número de paso, operador y pos...
                            )
                        )
                        (push (fifth nodo) *solution*)
                   )
              )
          )
