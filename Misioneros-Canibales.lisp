...
(if (or (or (not (and (= o0 1) (= l0 1))) (not (and (= w0 1) (= o0 1)))) (and (= 1 o0) (= 1 l0) (= 1 w0)));;es cierto cuando no se cumple ninguna de las restricciones 
            (if (or (or (not (and (= o1 1) (= l1 1))) (not (and (= w1 1) (= o1 1)))) (and (= 1 o1) (= 1 l1) (= 1 w1)));;es cierto cuando no se cumple ninguna de las restricciones
                T
                NIL
            )
            NIL
